...
- [ ] ! 彻底从ycmd切换到coc (2020-11-25 19:47)
  ...
  - [ ] 配置coc (2020-11-25 19:47)
    - [ ] 可参考：https://zhuanlan.zhihu.com/p/76033635 (2020-12-23 18:52)
...
- [X] ! 配置Fcitx5: (2020-12-18 18:03)
  - [X] 剪贴板条数设置为10 (2020-12-18 18:04)
- [X] ! 配置Guake的快捷键和字体 (2020-12-30 10:04)
- [X] App: (2020-12-23 15:35)
  - [X] + profile-sync-daemon: 将浏览器运行时文件缓存到tmpfs (2020-12-23 17:54)
    - [X] 0. 考虑全固态下是否需要该功能： (2020-12-23 18:46)
      - [X] 不需要：全固态速度够快了，而且该功能会导致login过程耗时翻倍 (2020-12-23 18:47)
    - [X] 1. 如果~/.config/psd/psd.conf已存在需要删除 (2020-12-23 17:55)
    - [X] 2. 使用systemd user模式管理psd.service (2020-12-23 17:56)
    - [X] 3. 启动psd.service时需要保证受到管理的浏览器未运行 (2020-12-23 17:57)
  - [X] + pigz: 提供并行gzip压缩器支持 (2020-12-23 16:59)
